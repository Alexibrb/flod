...
st.write("# :bar_chart: :violet[Gráficos de Operações DayTrade]")
...
if os.path.exists('resultados.csv'):
    ...
    ###################################### GRÁFICOS ######################################
    tab1, tab2, tab3, tab4, tab5, tab6 = st.tabs(['Saldo Acumulado', 'Resultado Diário WIN', 'Resultado Diário WDO', 'Desempenho Trade a Trade', 'Resultado Acumulado Por Ativo', 'Resultado Último Dia Operado '])
    with tab1:
        with st.container(height=550):
            st.markdown("# :chart_with_upwards_trend: :blue[Saldo Acumulado]")
            GrafArea = go.Figure()
    ...
    with tab2:
        with st.container(height=600):
            st.markdown("# :chart_with_upwards_trend: :blue[Resultado Diário Das Operaçõe Mini Índice]")
    ...
    with tab3:
        with st.container(height=600):
            st.markdown("# :chart_with_upwards_trend: :blue[Resultado Diário Das Operações Mini Dólar]")
            GrafBar = go.Figure()
    ...
    with tab4:
        with st.container(height=700):
            st.markdown("# :chart_with_upwards_trend: :blue[Desempenho Trade a Trade] ")

            df = tabela1.sort_values(by=['Data', 'Ativo'], ascending=True)
    ...
    with tab5:
        ...
        with st.container(height=600):  # 00FF00
            st.markdown("## :chart_with_upwards_trend: :blue[Resultado Acumulado Por Ativo] ")
    ...
    with tab6:
        with st.container(height=600):
            st.markdown("## :chart_with_upwards_trend: :blue[Resultado Último Dia Operado] ")
